...
class ATL_NO_VTABLE CScanner :
	...
	public IDispatchImpl<IScanner, &IID_IScanner, &LIBID_ScanSrvLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CScanner()
	{
...
public:
	...
	STDMETHOD(ScanFile)(BSTR lpwszPath, long* lOffset, BSTR* lpwszGUID);
	STDMETHOD(ScanArray)(VARIANT pData, long* lOffset, BSTR* lpwszGUID);
	STDMETHOD(LoadSignatures)(BSTR lpwszPath);
};
